...
Normalizzazione: Lo script esegue una pulizia delle espressioni regolari (RegEx) e inietta dinamicamente gli apici del glossario nel file Markdown.

Generazione Metadati: Vengono creati i file JSON strutturati (output_onix.json e output_schema_org.json) che fungono da carta d'identità digitale dell'opera.

Compilazione: Pandoc (con XeLaTeX o CSS personalizzati) compila i file di output (PDF, EPUB e Web-Book).
